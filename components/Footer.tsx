      ...
      <div className="container-width relative z-10">
        <div className="flex flex-col items-center justify-center">
          <motion.h2 
            ...
            className="text-3xl md:text-5xl font-bold text-center max-w-4xl mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[var(--primary)] to-[var(--accent)]"
          >
            Ready to take <span className="text-[var(--accent)]">your</span> digital presence to the next level?
          </motion.h2>
          ...
          <div className="mt-20 w-full flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <p className="text-[var(--foreground)]/70 text-sm">
                Copyright © {new Date().getFullYear()} Lakindu Perera
              </p>
            </motion.div>
            ...
            >
              <SocialIcon href="https://github.com/lakindudev" icon="github" />
              <SocialIcon href="https://www.linkedin.com/in/lakindu-perera-297b752b2/" icon="linkedin" />
              <SocialIcon href="https://www.instagram.com/lakindu_x/" icon="instagram" />
            </motion.div>
          </div>
        </div>
      </div>
